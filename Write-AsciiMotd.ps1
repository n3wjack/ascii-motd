...
$element = $r.ParsedHtml.getElementsByTagName("PRE") | where { $_.className -notlike "*text-dark*" } | random

Write-Host "`n$($element.innerText)" -ForegroundColor Cyan
Write-Host "`n  from: $url"
